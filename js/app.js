(() => {
                ...
                if ("click" === targetType) {
                    if (targetEvent.closest("[data-showmore-button]")) {
                        ...
                        if (!showMoreContent.classList.contains("_slide")) {
                            showMoreContent.scrollIntoView({
                                block: "start",
                                behavior: "smooth"
                            });
    ...
    (function() {
        ...
        const breakpointChecker = function() {
            ...
            if (true === breakpoint.matches) {
                if (void 0 !== mySwiper1) mySwiper1.destroy(true, true);
                return;
            } else if (false === breakpoint.matches) return enableSwiper();
        };
        const enableSwiper = function() {
            if (document.querySelector(".media__slider")) mySwiper = new core(".media__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
            ...
            if (document.querySelector(".blog__slider")) mySwiper1 = new core(".blog__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
